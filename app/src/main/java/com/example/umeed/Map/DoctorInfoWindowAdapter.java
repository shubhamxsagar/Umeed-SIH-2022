...
public class DoctorInfoWindowAdapter implements GoogleMap.InfoWindowAdapter {

    private Context context;

    public DoctorInfoWindowAdapter(Context context) {
    ...
    public View getInfoContents(@NonNull Marker marker) {
        ...
        Bitmap b = BitmapFactory.decodeResource(view.getResources(),R.drawable.marker_doctor);

...
public class BloodHospitalInfoWindowAdapter implements GoogleMap.InfoWindowAdapter {

    private Context context;

    public BloodHospitalInfoWindowAdapter(Context context) {
...
//        TextView address = view.findViewById(R.id.DataInfo);

        int height = 115;
        int width = 70;

        Bitmap b = BitmapFactory.decodeResource(view.getResources(),R.drawable.marker_blood);
        Bitmap smallMarker = Bitmap.createScaledBitmap(b, width, height, false);
        BitmapDescriptor smallMarkerIcon = BitmapDescriptorFactory.fromBitmap(smallMarker);

        city.setText(marker.getTitle());
//        phone.setText(marker.getTitle());

package com.example.umeed.utils
...
class CollapsibleConstraintLayout  : ConstraintLayout, AppBarLayout.OnOffsetChangedListener {
    ...
    override fun onAttachedToWindow() {
        ...
        if (parent is AppBarLayout) {
            ...
            mOpenToolBarSet.clone(context, com.example.umeed.R.layout.toolbar_layout)
            mCloseToolBarSet.clone(context, com.example.umeed.R.layout.layout_closed_toolbar)

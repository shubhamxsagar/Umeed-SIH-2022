...
import com.example.umeed.databinding.FragmentDoctorTreatmentBinding;
...
public class DoctorTreatment extends Fragment {

    FragmentDoctorTreatmentBinding binding;
    Activity context;

...
import com.example.umeed.Adapter.TablayoutAdapted.HospitalTreatmentsAdapter;
...
import com.example.umeed.databinding.FragmentHospitalBookingBinding;
...
public class HospitalBooking extends Fragment {

    FragmentHospitalBookingBinding binding;
    Activity context;
            ...
            public void onResponse(Call<HospitalTreatmentModel> call, Response<HospitalTreatmentModel> response) {
                ...
                if (!model.isError()){
                    if (model.getData()!= null){
                        ...
                        HospitalTreatmentsAdapter adapter = new HospitalTreatmentsAdapter(model.getData());

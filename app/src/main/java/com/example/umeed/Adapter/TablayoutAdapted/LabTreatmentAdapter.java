...
public class LabTreatmentAdapter extends RecyclerView.Adapter<LabTreatmentAdapter.ViewHolder> {

    public static String Medical;
    public static String Ambulance;
    ArrayList<HospitalTreatmentDataModel> list;

    public LabTreatmentAdapter(ArrayList<HospitalTreatmentDataModel> list) {
        this.list = list;
    }

    @NonNull
    @Override
    public LabTreatmentAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull LabTreatmentAdapter.ViewHolder holder, int position) {

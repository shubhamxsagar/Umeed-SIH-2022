...
public class DoctorTreatmentAdapter  extends RecyclerView.Adapter<DoctorTreatmentAdapter.ViewHolder> {

    public static String Medical;
    public static String Ambulance;
    ArrayList<HospitalTreatmentDataModel> list;

    public DoctorTreatmentAdapter(ArrayList<HospitalTreatmentDataModel> list) {
        this.list = list;
    }

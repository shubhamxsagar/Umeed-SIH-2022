...
import com.example.umeed.Adapter.TwoTabLayoutLab;
import com.example.umeed.Chat.ChatInfo;
import com.example.umeed.R;
import com.example.umeed.databinding.ActivityDoctorInfoBinding;
import com.example.umeed.databinding.ActivityLabInfoBinding;
import com.google.android.material.appbar.AppBarLayout;

public class LabInfo extends AppCompatActivity implements AppBarLayout.OnOffsetChangedListener{

    ActivityLabInfoBinding binding;
    AppBarLayout appBar;
    TwoTabLayoutLab fragmentsAdapter;
    private ConstraintLayout mLayout;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityLabInfoBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());
        mLayout = binding.shrinkingLayout;
//        mLayout2 = binding.shrinkingLayout2;

        fragmentsAdapter = new TwoTabLayoutLab(getSupportFragmentManager(),TwoTabLayoutLab.BEHAVIOR_RESUME_ONLY_CURRENT_FRAGMENT);
...
//        getSupportActionBar().setDisplayShowTitleEnabled(false);
        ...
        binding.LabName.setText(organizationname);
        binding.LabType.setText(type);
        binding.LabPhone.setText(mobileno);
        binding.LabEmail.setText(emailid);
        binding.LabWebsite.setText(website);
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            window.setStatusBarColor(this.getResources().getColor(R.color.purple_lab));
        }

        binding.chat.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent1 = new Intent(LabInfo.this, ChatInfo.class);
        ...
        binding.map.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(LabInfo.this, MapActivity.class);
